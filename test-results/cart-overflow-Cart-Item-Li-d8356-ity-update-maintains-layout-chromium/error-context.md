...
- Name: cart-overflow.test.ts >> Cart Item Limit & Overflow Testing >> TC-005: Cart item quantity update maintains layout
- Location: tests\e2e\cart-overflow.test.ts:215:3
