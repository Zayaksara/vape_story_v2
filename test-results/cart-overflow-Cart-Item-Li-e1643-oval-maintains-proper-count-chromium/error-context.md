...
- Name: cart-overflow.test.ts >> Cart Item Limit & Overflow Testing >> TC-004: Cart item removal maintains proper count
- Location: tests\e2e\cart-overflow.test.ts:182:3
