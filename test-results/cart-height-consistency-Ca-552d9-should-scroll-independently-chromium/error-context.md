...
- Name: cart-height-consistency.test.ts >> Cart Height Consistency >> Product grid should scroll independently
- Location: tests\e2e\cart-height-consistency.test.ts:31:3
