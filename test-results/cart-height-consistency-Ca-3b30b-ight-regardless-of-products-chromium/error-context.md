...
- Name: cart-height-consistency.test.ts >> Cart Height Consistency >> Cart panel should have fixed height regardless of products
- Location: tests\e2e\cart-height-consistency.test.ts:5:3
