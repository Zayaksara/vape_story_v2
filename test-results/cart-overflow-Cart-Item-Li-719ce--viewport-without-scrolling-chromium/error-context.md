...
- Name: cart-overflow.test.ts >> Cart Item Limit & Overflow Testing >> TC-003: Cart max 4 items visible on iPad viewport without scrolling
- Location: tests\e2e\cart-overflow.test.ts:144:3
