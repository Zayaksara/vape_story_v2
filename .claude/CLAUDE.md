...
> Auto-generated by [Laravel Brain](https://github.com/laramint/laravel-brain) on 2026-05-10T07:34:51+07:00.
> Re-run `php artisan brain:generate-rules --target=claude` after code changes.

This file provides guidance to Claude Code when working with the **story_vape** codebase.
...
- 🧱 **Fat Method** `DashboardController@resolvePeriod`
- 🧱 **Fat Method** `DashboardController@querySaleStats`
- 🧱 **Fat Method** `TodayTransactionController@mapSalesToTransactions`
